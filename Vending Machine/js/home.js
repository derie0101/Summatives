$(document).ready(function() {
    ...
    success: function(data) {
      $.each(data, function(index, item) {
        ...
        var row =
          ...
          itemid +
          '"<div class="col-md-3" id="index-0"style="width:200px;height:200px;margin:1%;padding:5px;border:2px solid black;background-color:pink;">';
        row += "<h4>";
  ...
  $("#make-purchase-button").click(function(event) {
    ...
    if (!$("#total-money-in").val()) {
      $("#messages").val(
        "Please deposit:  " + $("#item-price-" + index).text()
      );
      return false;
    }
    $.ajax({
...
//   var inventory = $("#item-quantity-" + index)
//     .text()
//     .slice(16);
//   inventory = parseInt(inventory, 10);
//   inventory--;
//   $("#item-quantity-" + index).text("Quantity Left:  " + inventory.toString());
// }
